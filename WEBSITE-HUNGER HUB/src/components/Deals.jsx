      ...
      <div className=" min-h-screen container flex flex-col justify-center pt-16 md:pt-0">
        ...
        <div className=" flex flex-col md:flex-row gap-10 mt-8">
          ...
          <div className=" w-full md:w-2/4 text-center md:text-start space-y-4">
            ...
            🔥 Bite Into Savings! 🔥 Hot Deals on Burgers That'll Ignite Your Taste Buds! Grab a Sizzle-Worthy Bite at Unbeatable Prices – Limited Time Only! Spice up Your Mealtime with Flavorful Discounts! 🍔💥 #BurgerBonanza #HotDeals #SizzlingSavings
            </p>
